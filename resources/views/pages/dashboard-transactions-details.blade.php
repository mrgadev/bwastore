            ...
            <div class="card-body">
              <div class="row">
                <div class="col-12 col-md-4">
                  <img src="{{Storage::url($transaction->product->galleries->first()->photos ?? '')}}" class="w-100 mb-3 rounded" alt="">
                </div>
              ...
              <form action="{{route('dashboard-transactions-update', $transaction->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <template v-if="status == 'SHIPPING'">
                        <div class="col-md-3">
                          ...
                          <input type="text" name="awb" v-model="resi" class="form-control">
                        </div>
                        <div class="col-md-2">
                ...
                <div class="row">
                  <div class="col-12 text-right">
                    <button class="btn btn-success mt-4" type="submit">Save Now</button>
                  </div>
                </div>
              </form>
            </div>
