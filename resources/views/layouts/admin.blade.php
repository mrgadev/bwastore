          ...
          <!-- Sidebar -->
           <div class="border-right" id="sidebar-wrapper">
            <div class="sidebar-heading text-center">
              <span class="material-symbols-rounded display-1 text-success">admin_panel_settings</span>
            </div>
                  ...
                  <ul class="navbar-nav d-none d-lg-flex ml-auto">
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu">
                        ...
                        <a href="index.html" class="dropdown-item text-danger d-flex align-items-center gap-3"><span class="material-symbols-rounded">logout</span>Logout</a>
                      </div>
                    </li>
                    {{-- <li class="nav-item">
